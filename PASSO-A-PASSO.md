...
Depois pede a senha. A padrão é:

```
makerbase
```

> ⚠️ **Enquanto você digita a senha, nada aparece na tela.** Nem asteriscos, nem pontinhos. Parece
...
> ⚠️ **Regra que não pode ser quebrada:** a parte do meio tem que ser **exatamente** o firmware que
...
> ⚠️ **Apagar o `c_helper.so` antes é obrigatório.** Se esse arquivo não existir no momento em que a
...
> ⚠️ **A reversão devolve o `printer.cfg` de fábrica.** Toda a calibração que você fez depois da
...
> ⚠️ A atualização da Elegoo **pode apagar seu `printer.cfg`** e pode forçar o nivelamento para o
...
- ▶️ [Vídeo do @SandMMakers](https://www.youtube.com/watch?v=Aoy3sI1lv1g)
